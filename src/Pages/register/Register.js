    ...
    return (
        ...
        <>
            <form onSubmit={HandleRegister} >
                <div className="p-2">
                    <h2 className='fw-bold text-center mb-5 text-success'>Registration Form</h2>
                    ...
                    <InputGroup className="mb-3">
                        ...
                        <FloatingLabel controlId="floatingInput" label="User Name" className="fw-bold">
                            <Form.Control name='Username' autoFocus type="text" value={FormData.Username} placeholder="username"
                                onChange={HandleChange} />
                        </FloatingLabel>
                    </InputGroup>
                    {errors.Username && <p className='mt-1 text-danger'>{errors.Username}</p>}
                    <InputGroup className="mb-3">
                        <InputGroup.Text id="basic-email "><i className="bi bi-person-check-fill text-primary"></i></InputGroup.Text>
                    ...
                    {errors.E_mail && <p className='mt-1 text-danger'>{errors.E_mail}</p>}
                    ...
                    <InputGroup className="mb-3">
                        ...
                        <FloatingLabel controlId="floatingpassword" label="Password" className="fw-bold" >
                            <Form.Control ref={PassToggle} name='Password' type="Password" value={FormData.Password} placeholder="name@example.com"
                                onChange={HandleChange} />
                        </FloatingLabel>
                    </InputGroup>

                    {errors.Password && <p className='mt-1 text-danger'>{errors.Password}</p>}
                    ...
                    {errors.gender && <p className='mt-1 text-danger'>{errors.gender}</p>}


                    <div className=" d-flex justify-content-end fw-bold ">
                        <Link className='mt-3 me-3' to='/' >Login Now</Link>
                        <button type="submit" className="btn btn-primary fw-bold " onClick={HandleRegister}>Register</button>
                    </div>
                </div>
            </form>
        </>
